...
//The Vending m/c would benifit from having a counter to count the Q_in and sameple it only at +ve edge
//because current setup requires Q_in to be high for 1.xx cycles and stay high for 0.xx cycles
